...
const typeDefs = gql`
  ...
  type Mutation {
    publishArticle(title: String!, content: String!): Article!
      @hasPermission(resources: ["Article:publish"])
    unpublishArticle(title: String!): Boolean
      @hasPermission(resources: ["Article:publish", "Article:delete"])
    deleteArticle(title: String!): Boolean
      @hasPermission(resources: ["Article:delete"])
  }
`;
      ...
      return [
        {
          ...
          content: 'A short text about authorization.',
        },
        {
          id: 2,
          title: 'About authentication',
          content: 'A short text about authentication.',
        },
